...
import { editEventComment, deleteEventComment } from '@/lib/services/commentService';
...
export async function PUT(
  request: NextRequest,
  { params }: { params: { groupId: string; eventId: string; commentId: string } }
) {
  try {
    ...
    // Call service layer
    const result = await editEventComment(groupId, commentId, userId, content);
    ...
    console.error('Error in PUT /api/groups/:groupId/events/:eventId/comments/:commentId:', error);
...
export async function DELETE(
  ...
  try {
    ...
    // Call service layer
    const result = await deleteEventComment(groupId, commentId, userId);
